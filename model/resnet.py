...
class ResNet50(object):
    ...
    def inference(self):
        ...
        with tf.variable_scope('scale5'):
            ...
            print(self.block4_3.get_shape()) 

        # Fully-Connected
        with tf.variable_scope('fc'):
            self.pool2 = avgpool(self.block4_3,4,1, 'pool2')
    ...
    def loss(self):
        with tf.name_scope('loss'):
            #entropy = tf.compat.v1.nn.softmax_cross_entropy_with_logits_v2(labels=self.labels, logits=self.logits)
    ...
    def predict(self, weights, is_logging=True, debug=False):
        '''
